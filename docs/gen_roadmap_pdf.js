...
const FASE_A = [
  ...
  { id: "A6", name: "Cumbre del runtime  🚧 en progreso", hz: "C",
    exito: "**parcial** — **verificador JVMS-estricto**, **GC generacional**, el **set de opcodes completo** (`invokedynamic` incluido) e **hilos de SO con paralelismo real ensanchado** (GIL removido; cómputo + lecturas + asignación lock-free en `JVM_THREADS=os`, con el `unsafe` de la asignación Miri-verificado) logrados; falta el **JMM**, locks por-estructura finos y/o el JIT.",
    items: [
...
const TOWER_ASCII = [
  ...
  cRow("     [ ] locks por-estructura finos · JMM (H4)"),
  cBar("└", "┘"),
...
const ROUTE_ASCII = [
  ...
  " · GC-safe           (os-gil = oráculo)  getState            → ◀ ACÁ: JMM (H4)",
].join("\n");
