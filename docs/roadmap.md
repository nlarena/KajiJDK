...
### Hito K2 · Ensanchado de la gramática 🟣 — ✅ 5 de 5 etapas (strings, estrechamiento y switch)
...
- [x] **Strings — hecho (2026-08-29).** Estaban afuera porque `strings::intern` estaba *en obra*: generarlos habría fabricado divergencias que nadie podía clasificar. La tabla de interning aterrizó (F3, hito 3), así que es lo primero que corresponde agregar
