...
- [ ] **Minimizar una forma que hoy resiste la reducción** — es greedy, así que llega a un mínimo **local**, y bajo el oráculo de repetición su predicado además es inestable. **Listo cuando** una forma que hoy resiste la reducción se minimiza, con el caso anotado
