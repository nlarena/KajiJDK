...
/**
 * A table's header, in Synth.
 *
 * <p>It is a region of its own and not part of the table, and it makes sense: the header is the
 * only part of a table that can be pressed and dragged, so it has states the cells do not have.
 */
