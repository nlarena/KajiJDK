...
/**
 * El encabezado de una tabla, en Synth.
 *
 * <p>Es una region propia y no parte de la tabla, y tiene sentido: el encabezado es lo unico de
 * una tabla que se puede apretar y arrastrar, asi que tiene estados que las celdas no tienen.
 */
public class SynthTableHeaderUI extends javax.swing.plaf.basic.BasicTableHeaderUI implements SynthUI, PropertyChangeListener {
    ...
    private SynthContext getContext(JComponent c, int state) {
        ...
        return new SynthContext(c, (r != null) ? r : Region.TABLE_HEADER, style, state, true);
    }
    ...
    public void update(Graphics g, JComponent c) {
        ...
        if (context.getStyle() != null) {
            context.getStyle().getPainter(context)
                    .paintTableHeaderBackground(context, g, 0, 0, c.getWidth(), c.getHeight());
        }
        paint(context, g);
    }
