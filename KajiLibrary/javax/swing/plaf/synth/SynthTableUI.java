 ...
 * Synth's table.
 *
 * <p>The same as the list, with one turn more: the grid lines also come from the style, and a
 * Synth table may have none at all. That is something the basic look and feel cannot express,
 * because for it the grid is a colour and is always there.
 */
