...
/**
 * El panel raiz de Synth.
 *
 * <p>El panel raiz es el que esta debajo de todo en una ventana, y por eso su fondo es el fondo de
 * la ventana entera. No dibuja mas que eso.
 *
 * <p>Es de las pocas que no implementan {@code PropertyChangeListener} por su cuenta: el panel raiz
 * de Swing ya escucha sus propias propiedades, y {@link javax.swing.plaf.basic.BasicRootPaneUI} es
 * el escucha.
 */
public class SynthRootPaneUI extends javax.swing.plaf.basic.BasicRootPaneUI implements SynthUI {
    ...
    protected void paint(SynthContext context, Graphics g) {
        // El panel raiz es todo fondo; ver la nota de la clase.
    }
