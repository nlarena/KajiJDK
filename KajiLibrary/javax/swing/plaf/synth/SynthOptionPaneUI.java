 ...
 * Synth's option pane.
 *
 * <p>The four message icons -- information, question, warning, error -- come from the style and
 * not from a table of images. It is what allows a Synth look and feel to change them without
 * replacing resources.
 */
public class SynthOptionPaneUI extends javax.swing.plaf.basic.BasicOptionPaneUI implements SynthUI, PropertyChangeListener {
    ...
    protected void paint(SynthContext context, Graphics g) {
        // The message and the buttons draw themselves.
    }
