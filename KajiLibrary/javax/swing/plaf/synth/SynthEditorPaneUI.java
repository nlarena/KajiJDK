...
/**
 * El panel de edicion de Synth, del que sale {@link SynthTextPaneUI}.
 *
 * <p>Un panel de edicion muestra contenido con estilos propios -- HTML, RTF --, asi que el estilo
 * de Synth le pone el marco y los colores de base, y el documento decide el resto adentro.
 */
public class SynthEditorPaneUI extends javax.swing.plaf.basic.BasicEditorPaneUI implements SynthUI, PropertyChangeListener {
    ...
    private SynthContext getContext(JComponent c, int state) {
        ...
        return new SynthContext(c, (r != null) ? r : Region.EDITOR_PANE, style, state, true);
    }
    ...
    public void update(Graphics g, JComponent c) {
        ...
        if (context.getStyle() != null) {
            context.getStyle().getPainter(context)
                    .paintEditorPaneBackground(context, g, 0, 0, c.getWidth(), c.getHeight());
        }
        paint(context, g);
    }
