...
/**
 * Synth's editor pane, which {@link SynthTextPaneUI} comes from.
 *
 * <p>An editor pane shows content with styles of its own -- HTML, RTF --, so Synth's style gives
 * it the frame and the base colours, and the document decides the rest inside.
 */
