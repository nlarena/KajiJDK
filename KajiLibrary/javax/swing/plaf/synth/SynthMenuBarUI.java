 ...
 * Synth's menu bar.
 *
 * <p>The bar draws nothing but its background: each menu inside draws itself. It is one of the
 * classes where Synth's sharing out comes out cleanest.
 */
public class SynthMenuBarUI extends javax.swing.plaf.basic.BasicMenuBarUI implements SynthUI, PropertyChangeListener {
    ...
    protected void paint(SynthContext context, Graphics g) {
        // Each menu draws itself; see the class note.
    }
