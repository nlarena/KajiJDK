...
/**
 * La interfaz grafica de MenuBar que reparte cada llamada entre varias.
 *
 * <h2>Que es</h2>
 *
 * <p>Guarda una lista de interfaces graficas de MenuBar y le pasa cada operacion a todas. Lo que
...
public class MultiMenuBarUI extends MenuBarUI {
    ...
    public boolean contains(JComponent jComponent, int i2, int i3) {
        boolean returnValue = ((MenuBarUI) uis.elementAt(0)).contains(jComponent, i2, i3);
        for (int i = 1; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).contains(jComponent, i2, i3);
        }
        return returnValue;
    }
    ...
    public void update(Graphics graphics, JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).update(graphics, jComponent);
        }
    }
    ...
    public void installUI(JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).installUI(jComponent);
        }
    }
    ...
    public void uninstallUI(JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).uninstallUI(jComponent);
        }
    }
    ...
    public void paint(Graphics graphics, JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).paint(graphics, jComponent);
        }
    }
    ...
    public Dimension getPreferredSize(JComponent jComponent) {
        Dimension returnValue = ((MenuBarUI) uis.elementAt(0)).getPreferredSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).getPreferredSize(jComponent);
        }
        return returnValue;
    }
    ...
    public Dimension getMinimumSize(JComponent jComponent) {
        Dimension returnValue = ((MenuBarUI) uis.elementAt(0)).getMinimumSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).getMinimumSize(jComponent);
        }
        return returnValue;
    }
    ...
    public Dimension getMaximumSize(JComponent jComponent) {
        Dimension returnValue = ((MenuBarUI) uis.elementAt(0)).getMaximumSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).getMaximumSize(jComponent);
        }
        return returnValue;
    }
    ...
    public int getAccessibleChildrenCount(JComponent jComponent) {
        int returnValue = ((MenuBarUI) uis.elementAt(0)).getAccessibleChildrenCount(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).getAccessibleChildrenCount(jComponent);
        }
        return returnValue;
    }
    ...
    public Accessible getAccessibleChild(JComponent jComponent, int i2) {
        Accessible returnValue = ((MenuBarUI) uis.elementAt(0)).getAccessibleChild(jComponent, i2);
        for (int i = 1; i < uis.size(); i++) {
            ((MenuBarUI) uis.elementAt(i)).getAccessibleChild(jComponent, i2);
        }
        return returnValue;
    }
}
