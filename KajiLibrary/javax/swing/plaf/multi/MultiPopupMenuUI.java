...
/**
 * The PopupMenu look and feel that shares out every call among several.
 *
 * <h2>What it is</h2>
 *
 * <p>It keeps a list of PopupMenu looks and feels and passes every operation to them all. What it
...
public class MultiPopupMenuUI extends PopupMenuUI {
     ...
     *
     * @param mouseEvent the {@code MouseEvent}
     ...
     * It asks them all and answers with the first.
     *
     * @param jPopupMenu the {@code JPopupMenu}
