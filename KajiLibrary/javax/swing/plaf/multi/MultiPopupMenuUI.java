...
/**
 * La interfaz grafica de PopupMenu que reparte cada llamada entre varias.
 *
 * <h2>Que es</h2>
 *
 * <p>Guarda una lista de interfaces graficas de PopupMenu y le pasa cada operacion a todas. Lo que
...
public class MultiPopupMenuUI extends PopupMenuUI {
     ...
     *
     * @param mouseEvent el {@code MouseEvent}
     * @return lo que haya contestado la primera
     */
    public boolean isPopupTrigger(MouseEvent mouseEvent) {
        boolean returnValue = ((PopupMenuUI) uis.elementAt(0)).isPopupTrigger(mouseEvent);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).isPopupTrigger(mouseEvent);
        }
        return returnValue;
    }
     ...
     * Se lo pide a todas y contesta la primera.
     *
     * @param jPopupMenu el {@code JPopupMenu}
     * @param i2 el {@code int}
     * @param i3 el {@code int}
     * @return lo que haya contestado la primera
     */
    public Popup getPopup(JPopupMenu jPopupMenu, int i2, int i3) {
        Popup returnValue = ((PopupMenuUI) uis.elementAt(0)).getPopup(jPopupMenu, i2, i3);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).getPopup(jPopupMenu, i2, i3);
        }
        return returnValue;
    }
    ...
    public boolean contains(JComponent jComponent, int i2, int i3) {
        boolean returnValue = ((PopupMenuUI) uis.elementAt(0)).contains(jComponent, i2, i3);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).contains(jComponent, i2, i3);
        }
        return returnValue;
    }
    ...
    public void update(Graphics graphics, JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).update(graphics, jComponent);
        }
    }
    ...
    public void installUI(JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).installUI(jComponent);
        }
    }
    ...
    public void uninstallUI(JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).uninstallUI(jComponent);
        }
    }
    ...
    public void paint(Graphics graphics, JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).paint(graphics, jComponent);
        }
    }
    ...
    public Dimension getPreferredSize(JComponent jComponent) {
        Dimension returnValue = ((PopupMenuUI) uis.elementAt(0)).getPreferredSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).getPreferredSize(jComponent);
        }
        return returnValue;
    }
    ...
    public Dimension getMinimumSize(JComponent jComponent) {
        Dimension returnValue = ((PopupMenuUI) uis.elementAt(0)).getMinimumSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).getMinimumSize(jComponent);
        }
        return returnValue;
    }
    ...
    public Dimension getMaximumSize(JComponent jComponent) {
        Dimension returnValue = ((PopupMenuUI) uis.elementAt(0)).getMaximumSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).getMaximumSize(jComponent);
        }
        return returnValue;
    }
    ...
    public int getAccessibleChildrenCount(JComponent jComponent) {
        int returnValue = ((PopupMenuUI) uis.elementAt(0)).getAccessibleChildrenCount(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).getAccessibleChildrenCount(jComponent);
        }
        return returnValue;
    }
    ...
    public Accessible getAccessibleChild(JComponent jComponent, int i2) {
        Accessible returnValue =
                ((PopupMenuUI) uis.elementAt(0)).getAccessibleChild(jComponent, i2);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) uis.elementAt(i)).getAccessibleChild(jComponent, i2);
        }
        return returnValue;
    }
}
