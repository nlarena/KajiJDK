...
/**
 * The ProgressBar look and feel that shares out every call among several.
 *
 * <h2>What it is</h2>
 *
 * <p>It keeps a list of ProgressBar looks and feels and passes every operation to them all. What
...
public class MultiProgressBarUI extends ProgressBarUI {
    ...
    public boolean contains(JComponent jComponent, int i2, int i3) {
        boolean returnValue = ((ProgressBarUI) uis.elementAt(0)).contains(jComponent, i2, i3);
        for (int i = 1; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).contains(jComponent, i2, i3);
        }
        return returnValue;
    }
    ...
    public void update(Graphics graphics, JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).update(graphics, jComponent);
        }
    }
    ...
    public void installUI(JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).installUI(jComponent);
        }
    }
    ...
    public void uninstallUI(JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).uninstallUI(jComponent);
        }
    }
    ...
    public void paint(Graphics graphics, JComponent jComponent) {
        for (int i = 0; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).paint(graphics, jComponent);
        }
    }
    ...
    public Dimension getPreferredSize(JComponent jComponent) {
        Dimension returnValue = ((ProgressBarUI) uis.elementAt(0)).getPreferredSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).getPreferredSize(jComponent);
        }
        return returnValue;
    }
    ...
    public Dimension getMinimumSize(JComponent jComponent) {
        Dimension returnValue = ((ProgressBarUI) uis.elementAt(0)).getMinimumSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).getMinimumSize(jComponent);
        }
        return returnValue;
    }
    ...
    public Dimension getMaximumSize(JComponent jComponent) {
        Dimension returnValue = ((ProgressBarUI) uis.elementAt(0)).getMaximumSize(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).getMaximumSize(jComponent);
        }
        return returnValue;
    }
    ...
    public int getAccessibleChildrenCount(JComponent jComponent) {
        int returnValue = ((ProgressBarUI) uis.elementAt(0)).getAccessibleChildrenCount(jComponent);
        for (int i = 1; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).getAccessibleChildrenCount(jComponent);
        }
        return returnValue;
    }
    ...
    public Accessible getAccessibleChild(JComponent jComponent, int i2) {
        Accessible returnValue =
                ((ProgressBarUI) uis.elementAt(0)).getAccessibleChild(jComponent, i2);
        for (int i = 1; i < uis.size(); i++) {
            ((ProgressBarUI) uis.elementAt(i)).getAccessibleChild(jComponent, i2);
        }
        return returnValue;
    }
}
