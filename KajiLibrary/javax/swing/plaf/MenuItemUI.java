...
/**
 * The look and feel of a menu item.
 *
 * <h2>An empty class with a purpose</h2>
 *
 * <p>It adds no method over {@link ButtonUI}: it exists to name the type. The component
 * declares that its look and feel is a {@code MenuItemUI} and not just any {@code ButtonUI},
