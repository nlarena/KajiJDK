...
/**
 * El aspecto de una opcion de menu.
 *
 * <h2>Una clase vacia con un proposito</h2>
 *
 * <p>No agrega ningun metodo sobre {@link ButtonUI}: existe para nombrar el tipo. El componente
 * declara que su aspecto es un {@code MenuItemUI} y no un {@code ButtonUI} cualquiera, y eso hace
