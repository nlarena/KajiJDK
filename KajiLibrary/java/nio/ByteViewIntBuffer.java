...
class ByteViewIntBuffer extends IntBuffer {
    ...
    ByteViewIntBuffer(ByteBuffer bytes, int byteOffset, int capacity, boolean bigEndian,
                      boolean isReadOnly) {
