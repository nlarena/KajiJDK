 ...
 *
 * <p>The pair is worth keeping side by side because it isolates what a scrambler does. Both take
 * the same combined state and both produce a well-distributed 64 bits; "**" is cheaper (three
 ...
 *
 * @implNote An INTERNAL class, same subset caveat as its sibling (nested SplittableGenerator,
 *     finding #101).
 */
